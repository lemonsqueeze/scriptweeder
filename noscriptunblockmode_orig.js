(function() {
    ...
    function(e) {
        ...
        if ((!blocksitescripts && scE.indexOf(location.hostname) != -1) || (location.hash=='#nsoff' || window.name.match(/ nsoff/))) {
        }
        else if((z && z.indexOf(scIi.toString()) != -1) || (v && v.indexOf(scE) != -1))
        {
        scA.push(scIil);
        }
        else {
